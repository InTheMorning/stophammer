ALTER TABLE wallet_identity_review RENAME TO wallet_identity_review_legacy_0023;
...
SELECT
    ...
    wallet_id,
    review_type,
    COALESCE(details, wallet_id),
    json_array(wallet_id),
    '[]',
    status,
    created_at,
    COALESCE(resolved_at, created_at)
FROM wallet_identity_review_legacy_0023;
