...
This endpoint remains canonical/transitional. For immediate source-truth reads,
use the feed and track endpoints.
...
This endpoint remains canonical/transitional. Source feed and track endpoints
remain the immediate preserved-RSS layer.
