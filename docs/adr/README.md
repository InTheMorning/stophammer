...
| [0060](0060-a-list-feed-keeps-its-items.md) | A `musicL` feed keeps `itemGuid`, `title` and its value block. Each entry gives its indexed track. The crawler follows a list, at most 1,000 URLs. Amends ADR 0049 §2 and ADR 0054 §3 | Proposed |
