...
CREATE INDEX IF NOT EXISTS idx_release_recordings_recording
    ON release_recordings(recording_id);
CREATE INDEX IF NOT EXISTS idx_release_recordings_source_track
    ON release_recordings(source_track_guid);
...
-- ============================================================
-- Wallet entities — fact layer + derived layer
-- ============================================================
