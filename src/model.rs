...
//! [`FeedPaymentRoute`], [`ValueTimeSplit`], and [`RawPodcastPerson`]. All types
...
#[expect(
    ...
    reason = "field names match Podcast Namespace / DB column conventions"
)]
...
/// Raw `podcast:person` row captured during ingest for later inspection.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RawPodcastPerson {
    pub id: Option<i64>,
